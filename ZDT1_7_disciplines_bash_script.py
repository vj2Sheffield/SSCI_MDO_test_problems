...
class disc1(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C1, z[1:2]), [C1.shape[0], 1])
		Dx = np.matmul(D1, x1)
		B1y = np.matmul(B1, y7)
...
class disc2(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C2, z[1:2]), [C2.shape[0], 1])
		Dx = np.matmul(D2, x2)
		B1y = np.matmul(B2, y1)
...
class disc3(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C3, z[1:2]), [C3.shape[0], 1])
		Dx = np.matmul(D3, x3)
		B1y = np.matmul(B3, y2)
...
class disc4(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C4, z[1:2]), [C4.shape[0], 1])
		Dx = np.matmul(D4, x4)
		B1y = np.matmul(B4, y3)
...
class disc5(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C5, z[1:2]), [C5.shape[0], 1])
		Dx = np.matmul(D5, x5)
		B1y = np.matmul(B5, y4)
...
class disc6(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C6, z[1:2]), [C6.shape[0], 1])
		Dx = np.matmul(D6, x6)
		B1y = np.matmul(B6, y5)
...
class disc7(om.ExplicitComponent):
	...
	def compute(self, inputs, outputs):
		...
		Cz = np.reshape(np.matmul(C7, z[1:2]), [C7.shape[0], 1])
		Dx = np.matmul(D7, x7)
		B1y = np.matmul(B7, y6)
